  ...
  const renderDoctorDetails = () => (
    <div className="relative z-10 text-gray-700 bg-gray-50 p-4 rounded-xl">
      ...
      <div className="mt-4">
        ...
        <img
          src={doctor.signatureImage ? `https://patient-management-system-kshy.onrender.com/${doctor.signatureImage}` : ""}
      ...
      <div className="w-1/4 bg-white p-6 h-full overflow-y-auto">
        ...
        <div className="relative p-4 bg-gradient-to-br from-[#4C49ED] to-[#020067] rounded-lg shadow-lg mb-6">
          <div className="flex items-center mb-4">
            <img
              src={doctor.profileImage ? `https://patient-management-system-kshy.onrender.com/${doctor.profileImage}` : userImage}
              alt="Doctor Profile"
